...
summary: Notion 지식베이스 보안 검토(1~6차)에서 반복 발견된 위험 패턴 목록 — 고정 비밀번호, Database Mail 자격증명, 무조건 인덱스 리빌드, TDE 해제 단계 혼입 등.
sources: ["Notion: 정리 및 보안 검토 보고서 (2026-07-30)"]
status: reviewed
created: 2026-08-04
updated: 2026-08-04
notion_page_id: null
...
> - **가장 위험한 패턴은 "일상 절차에 보안 상태를 바꾸는 단계가 섞여 있는 것"** — 일반 백업 절차에 TDE 해제·암호화 키 삭제가 들어있던 사례. 절차 문서 검토 시 이것부터 찾는다
