...
> - **Reorganize는 고침이 아니라 리셋이다.** 다음 파티션 경계에서 재발한다. "조치 완료"로 종결시키면 안 된다 — [[verbal-source-verification-policy]]의 대표 사례
...
> - 파티션을 미리 넉넉히 만들어도 해결되지 않는다 — 문제는 미래 파티션의 부재가 아니라 굳어버린 비트맵이다
